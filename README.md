...
Get road angle from closest point (degrees)  
```sql
...
# dissemination area
ogr2ogr -overwrite -f PostgreSQL -s_srs "EPSG:3347" -t_srs "EPSG:3857" -nlt promote_to_multi -nlt MULTIPOLYGON PG:dbname=osm lda_000b21a_e.shp lda_000b21a_e
```
...
psql -d osm -c "\COPY attributes_2021 FROM '2021_92-151_X_iconv.csv' WITH (FORMAT csv, DELIMITER ',', HEADER true);"
```
